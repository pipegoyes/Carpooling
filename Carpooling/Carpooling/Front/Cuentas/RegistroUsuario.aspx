...
<script type="text/javascript">
    ...
    //funcion avanzar paso wizard
    function IrPaso2() {
        if (Page_ClientValidate("ValidacionPaso1"))
        {
            ...
            <div id="pagesWizard">
                ...
                <div id="paso1">
                    ...
                    <div class="botonesBox">
                            <input id="btnSiguiente" type="button" onclick="IrPaso2()" value="Continuar" causesvalidation="true" validationgroup="ValidacionPaso1"/>
                    </div>
                </div>
                ...
                <div id="paso2">
                    ...
                    <div class="botonesBox">
                            <asp:Button ID="btnAtras1" runat="server" CausesValidation="False" Text="Atras"/>                
                ...
                <div id="paso3">
                    ...
                    <div class="botonesBox">
                        <asp:Button ID="btnAtras2" runat="server" Text="Atras"/>                
