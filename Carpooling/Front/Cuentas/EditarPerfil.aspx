<%@ Page Title="" Language="C#" MasterPageFile="~/Front/Site.Master" AutoEventWireup="true" CodeBehind="EditarPerfil.aspx.cs" Inherits="Carpooling.Front.Cuentas.EditarPerfil" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section id="datosPesonales">
        ...
        <fieldset>
            ...
            <div ClientID="fechaNacimiento">
                ...
                <asp:HiddenField ID="hfDiaNacimiento" runat="server" Value="-1"/>
            </div>
        </fieldset>
        <fieldset>
            <span>
    ...
    <section id="datosCuenta">
        <fieldset>
            ...
            <asp:TextBox ID="txbIdUsuario" runat="server" Text="No disponible" Enabled="false"></asp:TextBox>               
        </fieldset>
        <fieldset>
            <span>
                Email:
        ...
        <fieldset>
            ...
            <asp:TextBox ID="txnContraseniaActual" runat="server" Text="No disponible" TextMode="Password"></asp:TextBox>
            <span>
                Nueva contraseña:
            </span>
    ...
    <section id="datosAdicionales">
        <fieldset>
            ...
            <figure>
                ...
                <asp:LinkButton ID="lnkCambiarFoto" runat="server">Cambiar imagen</asp:LinkButton>
            </figure>
        </fieldset>
        <fieldset>
            <span>
    ...
    <section id="botones">
        <asp:Button ID="btnGuardarCambios" ClientID="btnGuardarCambios" runat="server" Text="Guardar cambios" style="float:left;"/>
    </section>
</asp:Content>
